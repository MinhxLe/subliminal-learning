...
def build_dataset_cfg(
    ...
    return dataset_services.Cfg(
        ...
        filter_fns=[lambda _, r: len(get_reject_reasons(r, min_value=0, max_value=999, max_count=10, banned_numbers=[])) == 0],
    )
...
control_dataset_cfg = build_dataset_cfg(None, "animal")
